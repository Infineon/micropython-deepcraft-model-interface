...
# INC needs an absolute path (compiler is invoked from the port directory).
INC   += -I$(DEEPCRAFT_MODEL_LIB_DIR)/deepcraft
DEEPCRAFT_MODEL_LIB_TOP_DIR := $(patsubst $(TOP)/%,%,$(DEEPCRAFT_MODEL_LIB_DIR))
SRC_C += $(DEEPCRAFT_MODEL_LIB_TOP_DIR)deepcraft/deepcraft_engine.c
SRC_C += $(DEEPCRAFT_MODEL_LIB_TOP_DIR)deepcraft/deepcraft_interface.c
